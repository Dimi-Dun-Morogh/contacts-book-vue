  ...
  computed: {
    ...
    forbiddenToDelete() {
      return this.details[0] === 'name' || this.details[0] === 'id'
        ? 'you can\'t delete' : 'are you sure to delete';
    },
    btnText() {
      return this.details[0] === 'name' || this.details[0] === 'id' ? 'sry' : 'DELETE';
    },
  },
  methods: {
    ...mapActions('contactsStore', ['setCurrentFieldToEdit', 'setViewModalFieldEdit', 'deleteField']),
    editField() {
